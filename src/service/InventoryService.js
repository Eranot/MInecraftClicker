...
class InventoryService {
    ...
    constructor() {
        ...
        this._inventorySlots = [
            ...
            // Regular inventory
            new InventorySlot(9, itemService.getItemById(ITEM.LEATHER), 64),
            ...
            new InventorySlot(15, itemService.getItemById(ITEM.BEEF), 64, 0),
            new InventorySlot(16, itemService.getItemById(ITEM.CHICKEN), 1),
            ...
            new InventorySlot(21, itemService.getItemById(ITEM.STICK), 64),
            new InventorySlot(22, itemService.getItemById(ITEM.COAL), 64),
            new InventorySlot(23, itemService.getItemById(ITEM.IRON_INGOT), 64),
            new InventorySlot(24, itemService.getItemById(ITEM.GOLD_INGOT), 64),
            new InventorySlot(25, itemService.getItemById(ITEM.DIAMOND), 64),
